...
adjectives = ["Able", "Acceptable", "Accurate", "Acidic", "Active", "Actual", "Additional",
    ...
    "Jealous", "Joint", "Jolly", "Juicy", "Junior", "Key", "Kind", "Kitchen", "Known", "Large",
    ...
    "Obvious", "Odd", "Official", "Old", "Open", "Opening", "Opposite", "Orange", "Ordinary", "Original",
    ...
    "Rough", "Round", "Royal", "Sad", "Safe", "Salmon", "Salty", "Scared", "Scary",
